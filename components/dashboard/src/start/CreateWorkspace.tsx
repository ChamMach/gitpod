      ...
      switch (error.code) {
        case ErrorCodes.CONTEXT_PARSE_ERROR:
          statusMessage = <div className="text-center">
            <p className="text-base mt-2">Are you trying to open a Git repository from a self-hosted instance? <a className="text-blue" href={"https://" + window.location.host + "/integrations"}>Add integration</a></p>
          </div>;
          break;
